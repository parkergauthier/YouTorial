...
DATABASE_USERNAME = toml_data["sql"]["DATABASE_USERNAME"]
DATABASE_PASSWORD = toml_data["sql"]["DATABASE_PASSWORD"]
DATABASE_HOST = toml_data["sql"]["DATABASE_HOST"]
DATABASE_PORT = toml_data["sql"]["DATABASE_PORT"]
DATABASE_DATABASE = toml_data["sql"]["DATABASE_DATABASE"]
